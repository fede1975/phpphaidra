<?php
	...
	define('GALLERY_ROOT', 'c:/xampp/htdocs/immagini/');
	define('DATA_ROOT', 'c:/xampp/htdocs/immagini2/');
	define('SECURITY_PHRASE', 'bdcqwjDbDIMhAjOydth9q87pIz1rOz');
	define('PASSWORD', '');
	define('ADMIN', FALSE);
